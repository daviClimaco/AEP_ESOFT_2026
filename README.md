...
Nesta etapa o sistema evolui para uma estrutura mais organizada e próxima de um ambiente real de produção.

Inclui:

- Link do GitHub com o código-fonte atualizado  
- Evolução do sistema com possível refatoração para padrão MVC  
- Relatórios (Word ou PDF):
  - Wireframes da interface  
  - Relatório de métricas e discussão dos resultados  
- Vídeo de apresentação (até 5 minutos):
  - Demonstração da evolução do sistema  
  - Apresentação dos resultados das métricas  
...
Projeto em desenvolvimento, evoluindo de uma versão inicial (Beta) para uma arquitetura mais estruturada.
